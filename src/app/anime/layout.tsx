...
import { IconSearch, IconMenu, IconBell, IconX } from '@tabler/icons-react'
  ...
  return (
    ...
    <div className="bg-indigo-600 pb-32">
            ...
            <div className="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
                ...
                <div className="hidden lg:ml-4 lg:block">
                    ...
                    >
                        ...
                        <IconBell className="cursor-pointer h-6 w-6" aria-hidden="true" />
                    </button>

                    {/* Profile dropdown */}
                    <Menu as="div" className="relative ml-3 flex-shrink-0">
                        <div>
                        <Menu.Button className="cursor-pointer flex rounded-full bg-indigo-600 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-white">Anime</h1>
        </div>
        </header>
    </div>
